...
class ClientController extends Controller
{
    ...
    public function index(): View{
        return view('client.conferences', ['conferences' => $this->conferences]);
    }
    public function show(int $id): View
    {
        abort_if(!isset($this->conferences[$id]), 404);
        return view('client.viewConference', ['conference' => $this->conferences[$id]]);
    }

    /**
     * Show the form for registering for a chosen event.
     */
    public function registerForConference(int $id): View
    {
        abort_if(!isset($this->conferences[$id]), 404);
